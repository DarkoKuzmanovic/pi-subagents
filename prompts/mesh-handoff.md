...
2. Second step: a synthesis `recon` that reads the parallel findings and writes the final handoff plan and meta-prompt.
...
Implementation-strategy recon, when used:
