...
`openai-codex/gpt-5.5` (correctness), `deepseek/deepseek-v4-pro` (depth), `minimax/MiniMax-M2.7-highspeed` (simplicity).
...
- Use the **strongest** model for the synthesis step (synthesis is harder than review); `openai-codex/gpt-5.5` is the default.
...
You receive the synthesis summary + `.pi/tmp/mesh-review/synthesis.md`. Read the synthesis. Then synthesize the findings into:
