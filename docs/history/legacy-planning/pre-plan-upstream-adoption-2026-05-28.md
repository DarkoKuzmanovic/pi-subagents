...
> **HISTORICAL (2026-05-28):** these upstream-adoption recon notes are retained only for context.
> They are not an active plan and do not link to a current planning document.
...
> The typecheck and test-workaround guidance below reflects the v0.31.1 environment and is obsolete. Use the root `AGENTS.md` and current package scripts for verification.
